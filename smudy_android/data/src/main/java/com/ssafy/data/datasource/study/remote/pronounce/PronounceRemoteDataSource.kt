...
interface PronounceRemoteDataSource {
    ...
    suspend fun gradePronounceProblem(userFile: MultipartBody.Part,ttsFile: MultipartBody.Part,json: RequestBody): Result<DefaultResponse<GradedPronounceResponse>>
}